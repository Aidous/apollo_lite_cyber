...
#ifndef PROTOBUF_modules_2fexamples_2fproto_2fexamples_2eproto__INCLUDED
#define PROTOBUF_modules_2fexamples_2fproto_2fexamples_2eproto__INCLUDED
...
class SamplesTest1 : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.examples.proto.SamplesTest1) */ {
 public:
  SamplesTest1();
  ...
  // @@protoc_insertion_point(class_scope:apollo.examples.proto.SamplesTest1)
 private:
  ...
  friend struct protobuf_modules_2fexamples_2fproto_2fexamples_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class Chatter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.examples.proto.Chatter) */ {
 public:
  Chatter();
  virtual ~Chatter();
  ...
  // @@protoc_insertion_point(class_scope:apollo.examples.proto.Chatter)
 private:
...
class Driver : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.examples.proto.Driver) */ {
 public:
  Driver();
  virtual ~Driver();
  ...
  // @@protoc_insertion_point(class_scope:apollo.examples.proto.Driver)
 private:
  void set_has_content();
  void clear_has_content();
  void set_has_msg_id();
...
class Image : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.examples.proto.Image) */ {
 public:
  Image();
  virtual ~Image();
  ...
  // @@protoc_insertion_point(class_scope:apollo.examples.proto.Image)
 private:
...
#endif  // PROTOBUF_modules_2fexamples_2fproto_2fexamples_2eproto__INCLUDED
